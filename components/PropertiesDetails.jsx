    ...
    <main>
      <div class="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
        ...
        <div class="text-gray-500 mb-4 flex align-middle justify-center md:justify-start">
          ...
          <p class="text-orange-700">120 Tremont Street Boston, MA 02111</p>
        </div>
        <h3 class="text-lg font-bold my-6 bg-gray-800 text-white p-2">
          Rates & Options
        </h3>
        <div class="flex flex-col md:flex-row justify-around">
          <div class="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <div class="flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9">
          <p>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none">
          ...
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Full kitchen
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Washer & Dryer
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Free Parking
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Hot Tub
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>24/7 Security
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Wheelchair
            Accessible
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Elevator Access
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Dishwasher
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Gym/Fitness
            Center
          </li>
          <li>
          ...
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Balcony/Patio
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Smart TV
          </li>
          <li>
            <i class="fas fa-check text-green-600 mr-2 mt-3"></i>Coffee Maker
          </li>
        </ul>
      </div>
      {/* <!-- Map --> */}
